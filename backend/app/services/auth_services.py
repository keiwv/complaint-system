...
"""
async def auth_staff(db: Prisma, login_data: AuthLogin):
...
Parameters:
- db: Prisma client instance
- staff_data: AuthCreate Pydantic model containing email, password, and name
Returns:
- Newly created Staff record
"""

async def register_staff(db: Prisma, staff_data: AuthCreate):
